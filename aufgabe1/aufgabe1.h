...
public:
  ...
  */
   ...
   * @return The pattern
  */
  const std::string& getPattern() const; // 2. const: Funktion verändert das Objekt nicht auf das sie angewandt wird
...
protected:
  ...
  */
  virtual void alignCheck_(const size_t text_pos) const {}; // leave this function empty. Just call it whenever you check an alignment. (in getHits)
